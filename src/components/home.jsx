...
//Icons
import { TouchApp, Web, TableChart, Flare, Hearing, Description, Spellcheck, AccountBalanceWallet, More, LocalOffer, Apps, Remove, AccountCircle, Cached, WebAsset, Autorenew,  NavigateNext, ExpandMore, ViewCarousel, Eject, Tab, Menu, Link, GetApp, GroupWork, CheckBox, Navigation, RadioButtonChecked, DateRange, SelectAll, Tune, ToggleOn, Textsms, List } from '@material-ui/icons';
